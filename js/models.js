import { resolveSize } from "./catalog.js";

export const TOOLS = [
  { type: "scale", label: "Шкала", glyph: "◔", hint: "Дуга + деления + подписи" },
  { type: "arc", label: "Дуга", glyph: "⌒", hint: "Дуга по углам" },
  { type: "circle", label: "Круг", glyph: "○", hint: "Окружность / диск" },
  { type: "sector", label: "Сектор", glyph: "◐", hint: "Цветовая зона шкалы" },
  { type: "line", label: "Линия", glyph: "/", hint: "Отрезок" },
  { type: "rect", label: "Рамка", glyph: "▭", hint: "Прямоугольник" },
  { type: "text", label: "Текст", glyph: "T", hint: "Надпись / единицы" },
];
